...
public class LandServiceTest {
	...
	public void before() {
		...
		when(landRepository.read("NL")).thenReturn(new Land("NL", 10));
	...
	@Test
	public void findVerhoudingOppervlakteNLTovOppervlakteAlleLanden() {
		assertEquals(0, BigDecimal.valueOf(0.5)
				.compareTo(landService.findVerhoudingOppervlakteLandTovOppervlakteAlleLanden("NL")));
	}

	@Test(expected = IllegalArgumentException.class)
	public void findVerhoudingOppervlakteSpaceTovOppervlakteAlleLanden() {
